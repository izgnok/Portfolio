...
public class Project {
    ...
    @Column(length = 500)
    private String githubUrl;  // GitHub 링크 (null 가능)
    ...
    public void update(String name, Integer teamSize, LocalDate startDate, LocalDate endDate,
                       String status, String githubUrl,  // ✨ 파라미터 추가
                       Boolean hasAward, String awardName, String awardOrganization,
